...
class NeuralNetwork():
    ...
    def draw(self, weights_list=None, rotation=0):
        ...
        pyplot.savefig(figureName, dpi=300, bbox_inches="tight", rotation=rotation)
        pyplot.show()
...
class DrawNN():
    ...
    def draw( self ):
        ...
        for l in self.neural_network:
            network.add_layer(l)
        network.draw(self.weights_list, rotation=120)